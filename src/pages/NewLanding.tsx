          ...
          >
            ...
            <div className="flex flex-col items-center gap-2 mt-2">
              ...
              <a 
                ...
                className="mt-4 flex items-center justify-center gap-2 rounded-full bg-white/20 px-5 py-2.5 text-sm font-medium text-[#25D366] transition-all hover:bg-white/30 border border-[#25D366]/30 hover:scale-105 shadow-sm"
              >
                ...
                <span className="drop-shadow-sm">Únete a VibeCoders Community</span>
              </a>
            </div>
          </div>
        )}
