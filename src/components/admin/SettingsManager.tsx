...
import { Loader2, Save, Plus, Trash2, Settings, Upload, RefreshCw, Database } from 'lucide-react';
    ...
    <div className="h-full overflow-y-auto space-y-6 pr-2">
      ...
      <div className="flex items-center justify-between pt-4">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="bg-white text-[#1C1C1C]">
            <DialogHeader>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="mt-1 bg-white border-gray-200 min-h-[80px]"
                />
              </div>
              <div>
