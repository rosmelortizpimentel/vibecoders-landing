        ...
        {user ? (
          ...
          >
            ...
            <p className="flex items-center gap-2 text-sm text-white/80">
              ...
              Los nombres de usuario cortos se están agotando.
            </p>
            
            {/* Google Sign In Button */}
            <button
              onClick={handleGoogleSignIn}
              className="flex h-14 w-full max-w-sm items-center justify-center gap-3 rounded-xl bg-white px-6 font-semibold text-gray-800 shadow-lg transition-all hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
            >
              ...
              Reclamar mi @username con Google
            </button>
            
            {/* Microcopy */}
            <p className="text-sm text-white/70">
              Sin listas de espera. Únete y publica tu primer proyecto hoy mismo.
            </p>
          </div>
        )}
      </div>
