          ...
          >
            ...
            <div className="flex flex-col items-center gap-2 mt-2">
              ...
              <a 
                ...
                className="mt-4 flex items-center justify-center gap-2 rounded-full bg-[#25D366]/10 px-5 py-2.5 text-sm font-medium text-[#25D366] transition-all hover:bg-[#25D366]/20 border border-[#25D366]/20 hover:scale-105"
              >
