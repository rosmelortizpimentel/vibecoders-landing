        ...
        {user ? (
          ...
          >
            ...
            <button
              ...
              className="flex h-14 w-full max-w-sm items-center justify-center gap-3 rounded-xl bg-white px-8 text-base font-semibold text-gray-800 shadow-lg transition-all hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
            >
